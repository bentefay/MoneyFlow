...
namespace Make.Utility
{
    public static class Parcel
    {
        ...
        {
            return Execute.RunToEither($"{Exe(projectDirectory)} {projectDirectory}/index.html --out-dir {outputDirectory} --cache-dir {cacheDirectory} --log-level {logLevel} --open");
        }
        ...
        {
            return Execute.RunToEither($"{Exe(projectDirectory)} build {projectDirectory}/index.html --out-dir {outputDirectory} --cache-dir {cacheDirectory} --log-level {logLevel}");
        }
